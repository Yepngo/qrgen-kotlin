...
import com.yepngo.qrgen.renderers.common.SvgPath2D
import java.awt.Graphics2D
import java.awt.geom.AffineTransform

internal class SingleEdgeRenderer {
    fun renderSingleMarker(
        gfx: Graphics2D,
        cellSize: Int,
        imgParams: ImgParameters,
    ) {
        val markerSize: Int = cellSize * MarkerRenderer.SIZE_OF_POSITION_MARKER

        val transform: AffineTransform = gfx.transform
    ...
    companion object {
        private val OUTER_PATH =
            "m 0,-61.400002 l 0.12695312,42.358986 C 0.15829613,-8.5831545 " +
        ...
        private val INNER_PATH =
            "m 37.23047,-43.836525 l -19.658204,0.0088 l -0.0073,19.448731 " +
