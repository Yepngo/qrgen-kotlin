...
internal object MaskUtil {
    ...
    fun applyMaskPenaltyRule3(matrix: ByteMatrix): Int {
        ...
        for (y in 0..<height) {
            for (x in 0..<width) {
                ...
                if (x + 6 < width && arrayY[x].toInt() == 1 && arrayY[x + 1].toInt() == 0 && arrayY[x + 2].toInt() == 1 &&
                    arrayY[x + 3].toInt() == 1 &&
                    arrayY[x + 4].toInt() == 1 &&
                    arrayY[x + 5].toInt() == 0 &&
                    arrayY[x + 6].toInt() == 1 &&
                ...
                if (y + 6 < height && array[y][x].toInt() == 1 && array[y + 1][x].toInt() == 0 && array[y + 2][x].toInt() == 1 &&
                    array[y + 3][x].toInt() == 1 &&
                    array[y + 4][x].toInt() == 1 &&
                    array[y + 5][x].toInt() == 0 &&
                    array[y + 6][x].toInt() == 1 &&
    ...
    fun getDataMaskBit(
        ...
        when (maskPattern) {
            0 -> {
                intermediate = (y + x) and 0x1
            }

            1 -> {
                intermediate = y and 0x1
            }
