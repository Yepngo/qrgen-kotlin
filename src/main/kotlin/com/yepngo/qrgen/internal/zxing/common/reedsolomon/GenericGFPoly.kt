 ...
 */
package com.yepngo.qrgen.internal.zxing.common.reedsolomon
...
internal class GenericGFPoly(
    ...
    fun addOrSubtract(other: GenericGFPoly): GenericGFPoly {
        ...
        for (i in lengthDiff..<largerCoefficients.size) {
    ...
    fun divide(other: GenericGFPoly): Array<GenericGFPoly?> {
        ...
        return arrayOf<GenericGFPoly?>(quotient, remainder)
    }
    ...
    override fun toString(): String {
        ...
        val result = StringBuilder(8 * this.degree)
        for (degree in this.degree downTo 0) {
