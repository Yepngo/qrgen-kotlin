 ...
 */
package com.yepngo.qrgen.internal.zxing.qrcode.decoder
...
internal class Version private constructor(
    ...
    init {
        ...
        var total = 0
        val ecCodewords: Int = ecBlocks[0].eCCodewordsPerBlock
        val ecbArray: Array<out ECB> = ecBlocks[0].eCBlocks
    ...
    fun buildFunctionPattern(): BitMatrix {
        val dimension = this.dimensionForVersion
    ...
    class ECBlocks internal constructor(
        ...
        val totalECCodewords: Int
            get() = this.eCCodewordsPerBlock * this.numBlocks
    }
    ...
    companion object {
        private val VERSIONS: Array<Version> = buildVersions()
